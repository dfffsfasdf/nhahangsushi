        ...
        <header class="header_section">
            <div class="container">
                <nav class="navbar navbar-expand-lg custom_nav-container ">
                    <a class="navbar-brand" href="{{ route('home_index') }}"><img width="150px"
                            src="{{ asset('themes/frontend/images/logo.png') }}" alt="#" /></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            <li class="nav-item active">
                                <a class="nav-link" href="{{ route('home_index') }}">Home <span
                            ...
                            <li class="nav-item">
                                @if ($cartNum > 0)
                                    <label class="badge bg-danger"
                                        style="position: absolute; top: -2px; color: white">{{ $cartNum }}</label>
                                @endif
                ...
                <div class="col-md-4">
                    <div class="full">
                        <div class="logo_footer">
                            <a href="#"><img width="210" src="{{ asset('themes/frontend/images/logo.png') }}"
                                    alt="#" /></a>
                        </div>
